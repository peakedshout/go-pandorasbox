...
type socks5Config struct {
	...
	uforward xnetutil.PacketListenerConfig
...
func newSocks5Config(network string, address string, cmd byte, auth *S5Auth, forward xnetutil.Dialer, uforward xnetutil.PacketListenerConfig, bindCb BINDAddrCb, udpCb UDPDataHandler) (*socks5Config, error) {
	return &socks5Config{
